...
class ClaudeCostTracker:
    ...
    def get_monthly_costs(self, year_month: str) -> Dict:
        ...
        return {
            ...
            'average_cost_per_review': round(total_cost / total_reviews, 4) if total_reviews > 0 else 0
        }
...
if __name__ == '__main__':
    ...
    print(f"Cost breakdown: Input=${result['cost_breakdown']['input']:.2f}, Output=${result['cost_breakdown']['output']:.2f}")