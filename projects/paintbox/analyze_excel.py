...
class ExcelAnalyzer:
    ...
    def analyze_named_ranges(self):
        ...
        try:
            ...
            for defined_name in defined_names:
                ...
                try:
                    destinations = list(defined_name.destinations) if hasattr(defined_name, 'destinations') else []
    ...
    def export_to_json(self, output_path: str):
        ...
        export_data = {
            ...
            'dependencies': {
                cell: list(deps) for cell, deps in self.cell_dependencies.items()
                if len(deps) > 0
            }
        }
