# Tyler Setup Platform - Production Infrastructure
# Comprehensive Terraform configuration for AWS deployment with blue-green strategy
...
terraform {
  ...
  backend "s3" {
    ...
    key            = "tyler-setup/terraform.tfstate"
    region         = "us-east-1"
    encrypt        = true
...
resource "aws_kms_key" "main" {
  description             = "Tyler Setup Platform encryption key"
...
# WebSocket Listener (separate port for real-time features)
...
resource "aws_elasticache_replication_group" "main" {
  ...
  description                = "Redis cluster for Tyler Setup Platform"
  ...
  container_definitions = jsonencode([
    {
      ...
      portMappings = [
        ...
        {
          containerPort = 3001  # WebSocket port
          protocol      = "tcp"
        }
      ]
...
resource "aws_ecs_service" "blue" {
  ...
  depends_on = [aws_lb_listener.https, aws_lb_listener.websocket]
