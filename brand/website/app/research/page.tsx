    ...
    <div className="min-h-screen bg-atelier-canvas">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section aria-labelledby="research-areas-heading">
          ...
          <article>
            <Link href="/research/monitoring" className="group block h-full focus:outline-none focus:ring-2 focus:ring-operation-active focus:ring-offset-2 rounded-lg">
              <div className="h-full p-6 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow border border-material-concrete">
                <header className="flex items-center mb-3">
                  <div className="w-10 h-10 bg-operation-active rounded-lg flex items-center justify-center mr-3" aria-hidden="true">
                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                    </svg>
                  </div>
                  <h3 className="text-xl font-semibold text-ink-primary group-hover:text-operation-active transition-colors">
                    NANDA Monitoring
                  </h3>
                </header>
          ...
          <article className="p-6 bg-white rounded-lg shadow-sm border border-material-concrete opacity-75">
            <header className="flex items-center mb-3">
              <div className="w-10 h-10 bg-gray-400 rounded-lg flex items-center justify-center mr-3" aria-hidden="true">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p className="text-sm text-gray-400 italic" role="status" aria-label="Status: Coming soon">Coming soon</p>
          </article>
        ...
        <aside className="mt-12 p-6 bg-blue-50 rounded-lg border border-blue-200" aria-labelledby="docs-hub-heading">
          <h2 id="docs-hub-heading" className="text-lg font-semibold text-blue-900 mb-2">
            <span aria-hidden="true">📚</span> Documentation Hub
          </h2>
          ...
          <Link
            href="/docs"
            className="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors"
          >
