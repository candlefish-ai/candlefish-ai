    ...
    <main className="min-h-screen bg-gradient-to-b from-[#0D1B2A] via-[#1B263B] to-[#1C1C1C] pt-24">
      <article className="max-w-3xl mx-auto px-6 pb-32">
        ...
        <section className="prose prose-invert prose-lg max-w-none">
          ...
          <p className="text-[#E0E1DD] leading-relaxed font-light">
            Patrick Smith: System architect. Former operational designer for painting 
            contractors, event promoters, retail operations. Believes every business 
            contains hidden elegance.
          </p>
          <p className="text-[#E0E1DD] leading-relaxed font-light">
            Tyler Fogg: Implementation craftsman. Transforms architectural 
            vision into living systems. Makes the complex feel simple.
          </p>
          <p className="text-[#E0E1DD] leading-relaxed font-light">
