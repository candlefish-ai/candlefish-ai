    ...
    <>
      ...
      <section className="min-h-screen relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32">
          ...
          {/* Supporting context */}
          <p className="mt-8 text-lg text-[#415A77] max-w-2xl font-light leading-relaxed">
      ...
      {/* PHILOSOPHY */}
      <section className="py-32 bg-[#1B263B]/30">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="text-3xl font-light text-[#F8F8F2] mb-12">
          ...
          <div className="space-y-6">
            <p className="text-[#E0E1DD] leading-relaxed font-light">
          ...
          <blockquote className="mt-16 pl-6 border-l-2 border-[#3FD3C6]">
            <p className="text-2xl font-light text-[#F8F8F2] leading-tight">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div>
              ...
              <p className="text-[#E0E1DD] mb-8 leading-relaxed font-light">
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-[#E0E1DD] font-light leading-relaxed">
