...
NANDA_AGENTS = {
    "orchestrator": {
        ...
        "status": "active",
        "reputation": 98.5,
        "metrics": {"tasks_completed": 1247, "avg_response_time": "87ms", "success_rate": "99.7%"},
    },
    "performance": {
        ...
        "status": "active",
        "reputation": 95.2,
        "metrics": {"optimizations": 523, "avg_improvement": "34%", "p95_latency": "142ms"},
    },
    "security": {
...
class NANDAEcosystem:
    ...
    def display_header(self):
        ...
        print_colored("\n" + "=" * 80, Colors.CYAN)
        print_colored(
            "                    CANDLEFISH NANDA ECOSYSTEM v2.0", Colors.BOLD + Colors.CYAN
        )
    ...
    def simulate_task_execution(self):
        ...
        print(
            f"{Colors.CYAN}[{self.agents['orchestrator']['name']}]{Colors.END} Forming consortium..."
        )
        ...
        for optimization, agent, duration in optimizations:
            print(
                f"   {Colors.GREEN}[{self.agents[agent]['name']}]{Colors.END} {optimization} ({duration})"
            )
            time.sleep(0.4)

        print(f"\n✅ {Colors.BOLD}{Colors.GREEN}Task completed successfully!{Colors.END}")
        print("   Result: 10x throughput achieved (24.8K ops/sec)")
        print("   Time taken: 645ms")
        print("   Credits earned: 250")
    ...
    def show_marketplace_activity(self):
        ...
        bidders = [("code_reviewer", 180), ("ml_engineer", 150), ("security", 200)]

        print(f"\n📢 New Task Available: {task}")
        print("   Base Reward: 200 credits")
        ...
        print("   Winning bid: 200 credits")
        print("   Task assigned and in progress...")
    ...
    def show_global_network(self):
        ...
        print("   Protocol: NANDA v2.0")
        print("   Consensus: CRDT-based")
        print("   Encryption: Ed25519")
        ...
        print("   Global Rank: #17")
        print("   Reputation Score: 96.8/100")
...
<body>
    <div class="container">
        ...
        for agent_id, agent in self.agents.items():
            capabilities = "".join(
                [f'<span class="capability">{cap}</span>' for cap in agent["capabilities"][:3]]
            )
            html += f"""
            <div class="card">
    ...
    <script>
        ...
        try:
            ...
            print("   Open manually: /tmp/nanda-live-ecosystem.html")
    ...
    def run(self):
        ...
        print_colored("\n" + "=" * 80, Colors.GREEN)
        print_colored(
            "            🎉 NANDA ECOSYSTEM SUCCESSFULLY DEPLOYED! 🎉", Colors.BOLD + Colors.GREEN
        )
        print_colored("=" * 80, Colors.GREEN)

        print(f"\n{Colors.CYAN}📌 Your Candlefish agents are now:{Colors.END}")
        print("   • Registered with the global NANDA network")
        print("   • Discoverable by any NANDA-compatible agent worldwide")
        print("   • Ready to form consortiums and execute tasks")
        print("   • Participating in the global agent marketplace")

        print(f"\n{Colors.YELLOW}🚀 Next Steps:{Colors.END}")
        print("   1. Configure SSL certificates for production endpoints")
        print("   2. Register custom agent capabilities")
        print("   3. Connect to enterprise clients")
        print("   4. Monitor performance at the dashboard")
